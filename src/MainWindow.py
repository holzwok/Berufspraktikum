...
class Ui_notepad(object):
    def setupUi(self, notepad):
        ...
        self.max_dist_over_waist = QtGui.QTextEdit(self.layoutWidget1)
        self.max_dist_over_waist.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.max_dist_over_waist.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.max_split_over_minor_axis = QtGui.QTextEdit(self.layoutWidget1)
        self.max_split_over_minor_axis.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.max_split_over_minor_axis.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.min_pixels_per_cell = QtGui.QTextEdit(self.layoutWidget1)
        self.min_pixels_per_cell.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.min_pixels_per_cell.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.max_pixels_per_cell = QtGui.QTextEdit(self.layoutWidget1)
        self.max_pixels_per_cell.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.max_pixels_per_cell.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(170, 30, 251, 161))
        self.layoutWidget3.setObjectName(_fromUtf8("layoutWidget3"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.layoutWidget3)
        self.verticalLayout_3.setMargin(0)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.lineEditworking_directory = QtGui.QLineEdit(self.layoutWidget3)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lineEditcell_id_executable = QtGui.QLineEdit(self.layoutWidget3)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lineEditfiji_executable = QtGui.QLineEdit(self.layoutWidget3)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lineEditspottyR_file = QtGui.QLineEdit(self.layoutWidget3)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(0, 30, 151, 111))
        self.layoutWidget4.setObjectName(_fromUtf8("layoutWidget4"))
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.layoutWidget4)
        self.verticalLayout_5.setMargin(0)
        self.verticalLayout_5.setObjectName(_fromUtf8("verticalLayout_5"))
        self.pb_images_directory = QtGui.QPushButton(self.layoutWidget4)
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(160, 30, 261, 111))
        self.layoutWidget5.setObjectName(_fromUtf8("layoutWidget5"))
        self.verticalLayout_6 = QtGui.QVBoxLayout(self.layoutWidget5)
        self.verticalLayout_6.setMargin(0)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.le_images_directory = QtGui.QLineEdit(self.layoutWidget5)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.le_niba_id = QtGui.QLineEdit(self.layoutWidget5)
        self.le_niba_id.setObjectName(_fromUtf8("le_niba_id"))
        self.verticalLayout_6.addWidget(self.le_niba_id)
        self.le_dic_id = QtGui.QLineEdit(self.layoutWidget5)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(1, 150, 421, 64))
        ...
        self.pb_save_session = QtGui.QPushButton(self.layoutWidget6)
        self.pb_save_session.setObjectName(_fromUtf8("pb_save_session"))
        self.horizontalLayout.addWidget(self.pb_save_session)
        self.pb_apply_session = QtGui.QPushButton(self.layoutWidget6)
        ...
        self.pb_load_session = QtGui.QPushButton(self.layoutWidget6)
