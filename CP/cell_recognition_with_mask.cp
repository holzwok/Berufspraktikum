...
IdentifyPrimaryObjects:[module_num:2|svn_version:\'11605\'|variable_revision_number:9|show_window:True|notes:\x5B\x5D|batch_state:array(\x5B\x5D, dtype=uint8)]
    ...
    Name the primary objects to be identified:CellShapes
    Typical diameter of objects, in pixel units (Min,Max):20,140
...
SaveImages:[module_num:3|svn_version:\'11658\'|variable_revision_number:7|show_window:True|notes:\x5B\x5D|batch_state:array(\x5B\x5D, dtype=uint8)]
    Select the type of image to save:Objects
    Select the image to save:Cells
    Select the objects to save:CellShapes
    Select the module display window to save:2\x3A IdentifyPrimaryObjects
